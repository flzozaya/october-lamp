...
CREATE TABLE `users_credentials` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_users_credentials_users_idx` (`user_id`),
  CONSTRAINT `fk_users_credentials_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-06 21:25:02
