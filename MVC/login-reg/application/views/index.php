		...
		<h1>Login & Reg</h1>
			...
			<form class="form-group" action="register" method="post">
				...
				<fieldset>
					...
					<label for="">Confirm Password: <input name="confirm_pass" type="password"></label>
			...
			<form class="form-group" action="login" method="post">
				...
				<fieldset>
					...
					<label for="">Username: <input name="login_username" type="text"></label>
					<label for="">Password: <input name="login_password" type="password"></label>
