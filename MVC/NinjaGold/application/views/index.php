...
<body>
	<div id="wrapper">
		...
		<p>Your Gold: <span class="current-gold"><?= $this->session->userdata('counter') ?></span></p>
		<div class="boxes">
			<form class="form-group" action="farm" method="get">
				<h3>Farm</h3>
		...
		<div class="boxes">
			<form class="form-group" action="cave" method="get">
				<h3>Cave</h3>
		...
		<div class="boxes">
			<form class="form-group" action="house" method="get">
				<h3>House</h3>
				<p>(earns 2 - 5 golds)</p>
		...
		<div class="boxes">
			<form class="form-group" action="casino" method="get">
				<h3>Casino!</h3>
